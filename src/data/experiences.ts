    ...
    positions: [
      {
        ...
        points: [
          "Automaticé la extracción diaria de datos y su carga al DWH usando Dagster y Python.",
          "Estandaricé estructuras de tablas y metadatos (pais/origen/versiones) para consumo en BI.",
          "Implementé validaciones de calidad (nulls, consistencia, historial) y resolví incidencias de carga y horarios.",
          "Implementé alertas y monitoreo para detectar fallas de extracción y cambios en APIs.",
          "Colaboré en evaluación técnica de herramientas de desarrollo (GitHub Copilot, Claude Code)",
          "Evalué e integré skills de agentes IA para estandarizar buenas prácticas y acelerar flujos de trabajo.",
