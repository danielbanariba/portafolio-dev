    ...
    positions: [
      {
        ...
        points: [
          "Construí y opero un fleet propio de servidores MCP (Model Context Protocol) que habilitan a la IA (Claude Code) operar Dagster, SQL Server, SMB, Dokploy, Microsoft Graph y health checks de APIs, con un flujo completo de CI/observabilidad; endurecidos con validador SQL read-only, blast-radius y OAuth2 (Zitadel), con optimización de consumo de tokens (~10-20x) y una auditoría adversarial multiagente con split de monolitos.",
          ...
          "Cerré un hueco de calidad de datos con un sensor genérico de AssetCheckEvaluation que notifica solo errores a Discord/Telegram/email con dedup por cursor; destapó un duplicado silencioso de 182,928 filas que pasaba con todos los runs en verde.",
