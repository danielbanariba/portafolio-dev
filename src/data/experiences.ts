    ...
    positions: [
      {
        ...
        points: [
          ...
          "Migré procesos legacy de Windows a Dagster, eliminando dependencia de VMs con Task Scheduler y credenciales de dominio.",
          ...
          "Implementé alertas por email para fallas de extracción y cambios en APIs, con monitoreo de ejecución en Dagster.",
