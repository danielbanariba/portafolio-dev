...
export const skills: Skill[] = [
  ...
  //---------------------------------------------Gestores de Bases de Datos---------------------------
  { name: 'Oracle', icon: '/icon/skills/oracle.svg', category: 'Gestores de Bases de Datos' },
  // { name: 'MySQL', icon: '/icon/skills/mysql.svg', category: 'Gestores de Bases de Datos' },
  { name: 'PostgreSQL', icon: '/icon/skills/postgresql.svg', category: 'Gestores de Bases de Datos' },
  { name: 'MongoDB', icon: '/icon/skills/mongodb.svg', category: 'Gestores de Bases de Datos' },
  // { name: 'SQLite', icon: '/icon/skills/sqlite.svg', category: 'Gestores de Bases de Datos' },
  { name: 'DynamoDB', icon: '/icon/skills/aws-dynamodb.svg', category: 'Gestores de Bases de Datos' },

  //---------------------------------------------Infraestructura---------------------------------
  { name: "Azure", icon: "/icon/skills/azure.svg", category: "Infraestructura" },
  { name: "AWS", icon: "/icon/skills/aws.svg", category: "Infraestructura" },
  { name: "Terraform", icon: "/icon/skills/terraform.svg", category: "Infraestructura"},
  { name: "Docker", icon: "/icon/skills/docker.svg", category: "Infraestructura" },
